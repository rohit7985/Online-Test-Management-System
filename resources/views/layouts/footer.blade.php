...
<!-- Bootstrap core JavaScript -->
  ...
  <script src="{{url('vendor1/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

  <script src="{{url('assets1/js/isotope.min.js')}}"></script>
  <script src="{{url('assets1/js/owl-carousel.js')}}"></script>
  <script src="{{url('assets1/js/lightbox.js')}}"></script>
  <script src="{{url('assets1/js/tabs.js')}}"></script>
